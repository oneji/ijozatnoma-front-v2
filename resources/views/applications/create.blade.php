        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div class="form-group">
                    <input type="text" class="custom-control" placeholder="НОМ ВА НАСАБ...">
                </div>
                <div class="form-group">
                    <div class="custom-select-wrapper">
                        <select name="" class="custom-control">
                ...
                <div class="form-group">
                    <div class="datepicker-wrapper">
                        <input type="text" class="custom-control datepicker" placeholder="БА МУҲЛАТИ...">
                    </div>
                </div>
                <div class="form-group">
                    <input type="number" class="custom-control" placeholder="НОМ ВА НАСАБ...">
                </div>
                <div class="form-group">
                    <div class="form-group">
                        <input type="file" name="file-7[]" id="file-7" class="custom-file-input" data-multiple-caption="{count} файлро интихоб кард" multiple>
                        <label for="file-7">
